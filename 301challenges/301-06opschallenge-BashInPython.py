...
# Script Name:                  Ops Challenge: 301Class06-301-06opschallenge-BashInPython
# Author:                       Ben Hobbs
# Date of latest revision:      06/6/2023
...
s_off = os.system("whoami")
addys = os.system("ip a")
sys_specs = os.system("lshw -short")
